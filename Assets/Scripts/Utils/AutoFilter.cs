...
#pragma warning disable 649
    ...
    {
        public event Action<SliderEvent> YieldValue;
        ...
        public void Provide(uint? value)
        {
            ...
            SliderEvent sliderEvent = new SliderEvent(GetTypeFor(last.value, output), output);
            last = (output, currentTime);
            YieldValue(sliderEvent);
        }
        ...
        public void Generate()
        {
            ...
            YieldValue(new SliderEvent(GetTypeFor(last.value, value), value, autoGenerated: true));
        }
