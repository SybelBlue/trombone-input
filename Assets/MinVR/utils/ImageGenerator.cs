namespace MinVR
{
    public class ImageGenerator : UnityEngine.MonoBehaviour, VREventGenerator
    {
        void Start()
        {
        ...
        // for the image data.
        public void AddEventsSinceLastFrame(ref System.Collections.Generic.List<VREvent> eventList)
        {
            int w = 100;
            int h = 100;
