    ...
    public class FakeTrackingInput : MonoBehaviour, VREventGenerator
    {
        ...
        private void AddTrackerEvents(ref List<VREvent> eventList)
        {
            ...
            else if (Input.GetKey(KeyCode.LeftControl))
            {
                ...
                if (curTracker == 0)
                {
                    tracker1Rot = Quaternion.AngleAxis(angle, Vector3.back) * tracker1Rot;
                }
                else if (curTracker == 1)
                {
                ...
                if (curTracker == 0)
                {
                    tracker1Rot = Quaternion.AngleAxis(angle, Vector3.right) * tracker1Rot;
                }
                else if (curTracker == 1)
                {
                    tracker2Rot = Quaternion.AngleAxis(angle, Vector3.right) * tracker2Rot;
                }
            }
            else
            {
